...
import { GetMovieCasts, GetMovieDetail, GetMovieVideo, GetSimilarMovie } from '../actions/movieActions'
            ...
            {detail.loading ?
                ...
                <>
                    ...
                    <div className="similarMovie__container">
                        <h3>Looking for similar movies with "{detail.movie.title}" ?</h3>
